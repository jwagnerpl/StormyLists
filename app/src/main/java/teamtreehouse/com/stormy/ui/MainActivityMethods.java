...
import teamtreehouse.com.stormy.adapters.SectionsStatePagerAdapter;
import teamtreehouse.com.stormy.fragments.MainActivityFragment;
...
public class MainActivityMethods extends AppCompatActivity {

    private SectionsStatePagerAdapter sectionsStatePagerAdapter;
    public static final String TAG = MainActivityMethods.class.getSimpleName();
    ...
    private void setupFrameLayout(FrameLayout frameLayout){
        ...
        //transaction.add(R.id.placeHolder, maf.get);
        transaction.commit();
    }
